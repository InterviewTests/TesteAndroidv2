...
import com.example.testesantander.statement.StatementActivity;

public class LoginActivity extends AppCompatActivity implements LoginContract.View {

    public static final String HELVETICA_NEUE_LIGHT_OTF = "HelveticaNeue-Light.otf";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textInputLayout = findViewById(R.id.textUsernameInputLayout);
        textInputLayout2 = findViewById(R.id.texPasswordtInputLayout2);
    ...
    public void setFonts(){
        Typeface font = Typeface.createFromAsset(getAssets(), HELVETICA_NEUE_LIGHT_OTF);
