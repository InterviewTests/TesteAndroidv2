...
public class CurrencyActivity extends BaseActivity implements CurrencyHandle {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        activityCurrencyBinding = DataBindingUtil.setContentView(this, R.layout.activity_main);
        currencyViewModelFactory = new CurrencyViewModelFactory(new CurrencyModel(),this);
