...
public class AccountActivity extends AppCompatActivity {
    ...
    private void setUserData(LoginResponse loginResponse) {
        ...
        account.setText(loginResponse.getClientData().getBankAccount() +
                        getString(R.string.separator) +
                        formatAccount(loginResponse.getClientData().getAgency()));

        balance.setText(getResources().getString(R.string.value_type) +
                        loginResponse.getClientData().getBalance().toString());
    }
