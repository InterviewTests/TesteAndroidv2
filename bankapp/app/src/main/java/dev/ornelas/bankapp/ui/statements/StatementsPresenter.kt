...
import dev.ornelas.banckapp.domain.interactors.RemoveLoggedUser
...
class StatementsPresenter(
    ...
    private val removeLoggedUser: RemoveLoggedUser
    ...
    override fun onLogout() {
        removeLoggedUser()
        view.displayStatements(StatementsViewModel(logedOut = true))
    }
}