...
* Arquitetura a ser utilizada: MVP CleanArchitecture (https://medium.com/android-dev-br/clean-architecture-para-android-eb492513263e && https://github.com/android10/Android-CleanArchitecture
* Uso do git.
