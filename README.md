...
=======
# TODO
- pré-configurar softwares
- fork do projeto, abstrair conceitos, analisar requisitos, definir arquitetura
- gerar projeto
- > cíclico (dependências Gradle)
- definir activities
- layout activities/fragments
- layout views (recycler)
- layout resources 
- layout fonts
- consultar respostas API json
- implementar Models
- implementar Tests
- implementar classes clean (activity, interactor, presenter)


>>>>>>> 2019-02-12 - Commit Inicial - criação do projeto
