...
class StatementRepositoryTest {
    ...
    fun setup() {
        ...
        statementRepository = StatementRepositoryImpl(statementDataSource)
    ...
    fun executeLoadStatements_verifyStatements() = runBlocking {
        ...
        statementRepository.loadStatements(1)
    ...
    fun getStatements_confirmObtained() = runBlocking {
        ...
        val statements = statementRepository.getStatements(1).getOrAwaitValue()
