...
const val FONT_HELVETICANEUELIGHT = "helveticaneue-light.otf"
const val FONT_HELVETICANEUE = "HelveticaNeue-Condensed.otf"
const val PASSWORD_PATTERN = "^(?=.*[0-9])(?=.*[a-z])(?=.*[A-Z])(?=.*[@#$%^&+=])(?=\\S+$).{4,}$"
const val CPF_PATTERN = "^([0-9]{3}\\.?){3}-?[0-9]{2}$"
const val MOCK_FAILED = "Mock failed successfully"